...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run() {
        String[] text = new String[]{ "MADARIN ORIENTAL HOTEL", "FOUR SEASONS HOTEL", "JW MARRIOTT HOTEL", "RADDISSION BLUE HOTEL", "CLASSSIO HOTEL", "JENNY'S RESIDENCY", "THE BAY CLUB HOTEL", "BREEZE BLOW HOTEL", "THE TAJ HOTEL", "HAPPY MOTEL"};
    ...
    CheckHotels() {
        ...
        ImageIcon[] kimage = new ImageIcon[] { k1, k2, k3, k4, k5, k6, k7, k8, k9, k10 };
         ...
         for (int i = 0; i <= 9; i++) {
             ...
             label[i] = new JLabel(kimage[i]); // Use the array of labels
